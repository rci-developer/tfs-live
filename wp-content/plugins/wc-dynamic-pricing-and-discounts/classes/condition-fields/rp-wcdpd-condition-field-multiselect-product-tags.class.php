...
class RP_WCDPD_Condition_Field_Multiselect_Product_Tags extends RP_WCDPD_Condition_Field_Multiselect
{
    ...
    {
        return RightPress_Conditions_Helper::get_all_product_tags($ids, $query);
    }
    ...
    {
        return __('Select product tags', 'rp_wcdpd');
    }
