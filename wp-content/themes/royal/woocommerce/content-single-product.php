    ...
    <div class="row">
                        ...
                        <div class="fixed-product-block">
                            <div class="fixed-content">
                                ...
                                if(etheme_get_option('show_product_title')) {
                                    ...
                                    echo do_shortcode('[share title="'.__('Share Social', 'royal').'" text="'.get_the_title().'"]');
                                 ?>
                             </div>
                         </div>
                    </div>
                    ...
                    <div class="product-information-inner <?php if($layout == 'fixed') echo 'fixed-product-block' ?>">
                        <div class="fixed-content">
                            <div class="product-navigation clearfix">
                                <h4 class="meta-title"><span><?php esc_html_e('Product Description', 'royal'); ?></span></h4>
        ...
        <?php if($l['sidebar'] != '' && $l['sidebar'] != 'without' && $l['sidebar'] != 'no_sidebar'): ?>
            ...
            <?php if (etheme_get_option('single_sidebar_responsive_display') && etheme_get_option('single_sidebar') != 'without') : ?>
                <button type="button" class="btn filled medium" id="show-shop-sidebar"><?php esc_html_e('Show sidebar', 'royal'); ?></button> <div class="hidden-shop-sidebar already-hidden"> <?php endif; ?>
