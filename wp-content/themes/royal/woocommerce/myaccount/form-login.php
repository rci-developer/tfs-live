...
<div class="row" id="customer_login">
	...
	<div class="col-sm-6">
		...
		<form method="post" class="login login-form woocommerce-form woocommerce-form-login">
			...
			<button type="submit" class="woocommerce-Button btn btn-black big pull-left" name="login" value="<?php esc_attr_e( 'Login', 'royal' ); ?>"><?php esc_html_e( 'Login', 'royal' ); ?></button>
			<p class="lost-password pull-left woocommerce-LostPassword lost_password"><?php esc_html_e('Lost your password?', 'royal'); ?> <a href="<?php echo esc_url( wc_lostpassword_url() ); ?>"><?php esc_html_e( 'Remind password', 'royal' ); ?></a></p>

			<label for="rememberme" class="woocommerce-form__label woocommerce-form__label-for-checkbox inline">
				<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php esc_html_e( 'Remember me', 'royal' ); ?>
			</label>
	...
	<div class="col-sm-6">
		...
		<form method="post" class="register">
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="woocommerce-Button button button big" name="register" value="<?php esc_attr_e( 'Register', 'royal' ); ?>"><?php esc_html_e( 'Register', 'royal' ); ?></button>
			</p>
