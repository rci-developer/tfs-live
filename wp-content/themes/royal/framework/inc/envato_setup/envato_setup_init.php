				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => esc_html__( 'Upgrade', 'envato_setup' ),
							'description' => esc_html__( 'Upgrade Content and Settings', 'envato_setup' ),
							'pending' => esc_html__( 'Pending.', 'envato_setup' ),
							'installing' => esc_html__( 'Installing Updates.', 'envato_setup' ),
							'success' => esc_html__( 'Success.', 'envato_setup' ),
