    ...
    function etheme_enqueue_styles() {
       global $etheme_responsive;
        ...
        if ( !is_admin() ) {
            ...
            wp_localize_script( 'etheme', 'myAjax', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ), 'noresults' => esc_html__('No results were found!', 'royal')));
    ...
    function etheme_init() {
        ...
        ?>
            ...
            <?php
                ...
                <?php et_load_bg_option( etheme_get_option('top_bar_bg'), 'div[class*="header-type-"] .top-bar,div[class*="header-type-"].slider-overlap .top-bar,div[class*="header-type-"].slider-overlap .top-bar > .container,div[class*="header-type-"] .top-bar > .container' ); ?>
                 ...
                 <?php
                    ...
                    $fixed_menufont_link_color_var = etheme_get_option( 'fixed_menufont_link_color_var' );
                    $fixed_menu_l2states = etheme_get_option( 'fixed_menufont_2' );
                    $fixed_menu_l2states_var = etheme_get_option( 'fixed_menufont_2_var' );
                    $fixed_menu_l3states = etheme_get_option( 'fixed_menufont_3' );
                    $fixed_menu_l3states_var = etheme_get_option( 'fixed_menufont_3_var' );
                  ?>
                ...
                <?php if ( ! empty( $fixed_menu_states ) ) echo jsString($selectors['fixed_menu_font']); ?> { color: <?php echo $fixed_menu_states; ?> !important; }

                <?php if ( ! empty( $fixed_menufont_link_color_var['hover'] ) ) echo jsString($selectors['fixed_menu_font_hover']); ?> { color: <?php echo $fixed_menufont_link_color_var['hover']; ?> !important; }

                <?php if ( ! empty( $fixed_menufont_link_color_var['active'] ) ) echo jsString($selectors['fixed_menu_font_active']); ?> { color: <?php echo $fixed_menufont_link_color_var['active']; ?> !important; }

                <?php if ( ! empty( $fixed_menu_l2states ) ) echo jsString($selectors['fixed_menu_l2']); ?> { color: <?php echo $fixed_menu_l2states; ?> !important; }

                <?php if ( ! empty( $fixed_menu_l2states_var['hover'] ) ) echo jsString($selectors['fixed_menu_l2_hover']); ?> { color: <?php echo $fixed_menu_l2states_var['hover']; ?> !important; }

                <?php if ( ! empty( $fixed_menu_l2states_var['active'] ) ) echo jsString($selectors['fixed_menu_l2_active']); ?> { color: <?php echo $fixed_menu_l2states_var['active']; ?> !important; }

                <?php if ( ! empty( $fixed_menu_l3states ) ) echo jsString($selectors['fixed_menu_l3']); ?> { color: <?php echo $fixed_menu_l3states; ?> !important; }

                <?php if ( ! empty( $fixed_menu_l3states_var['hover'] ) ) echo jsString($selectors['fixed_menu_l3_hover']); ?> { color: <?php echo $fixed_menu_l3states_var['hover']; ?> !important; }

                <?php if ( ! empty( $fixed_menu_l3states_var['active'] ) ) echo jsString($selectors['fixed_menu_l3_active']); ?> { color: <?php echo $fixed_menu_l3states_var['active']; ?> !important; }
            </style>
            <?php
            ...
            <script type="text/javascript">
                ...
                var successfullyAdded   = '<?php echo esc_js(__('successfully added to your shopping cart', 'royal')); ?>';
                var errorAdded          = '<?php echo esc_js(__('sorry you can\'t add this product to your cart', 'royal')); ?>';
                ...
                <?php if (class_exists('WooCommerce')) {
                    ...
                    ?>
                        ...
                        var contBtn = '<?php echo esc_js(__('Continue shopping', 'royal')); ?>';
                        var checkBtn = '<?php echo esc_js(__('Checkout', 'royal')); ?>';
                    <?php
                } ?>
...
if(!function_exists('etheme_register_menus')) {
    function etheme_register_menus() {
        register_nav_menus(array(
            'main-menu' => esc_html__('Main menu (left, default)', 'royal'),
            'main-menu-right' => esc_html__('Main menu (right)', 'royal'),
            'mobile-menu' => esc_html__('Mobile menu', 'royal'),
        ));
    }
}
...
if(!function_exists('et_wp_title')) {
    ...
    function et_wp_title($title) {
        ...
        if ( $paged >= 2 || $page >= 2 )
            $title .= ' | ' . esc_html__( 'Page ', 'royal' ) . max( $paged, $page ) ;
...
if(!function_exists('et_get_the_title')) {
    function et_get_the_title() {
        ...
        // Search Page
        if ( is_search() ) {
            return esc_html__( 'Search Results for: ', 'royal' ) . get_search_query();
        }

        // Archive Pages
        if ( is_archive() ) {
            if ( is_author() ) {
                return esc_html__( 'All posts by ', 'royal' ) . get_the_author();
            }
            elseif ( is_day() ) {
                return esc_html__( 'Daily Archives: ', 'royal' ) . get_the_date();
            }
            elseif ( is_month() ) {
                return esc_html__( 'Monthly Archives: ', 'royal') . get_the_date( _x( 'F Y', 'monthly archives date format', 'royal' ) );
            }
            elseif ( is_year() ) {
                return esc_html__( 'Yearly Archives: ', 'royal' ) . get_the_date( _x( 'Y', 'yearly archives date format', 'royal' ) );
            }
            elseif ( is_tag() ) {
                return esc_html__( 'Tag Archives: ', 'royal' ) . single_tag_title( '', false );
            }
            elseif ( is_category() ) {
                return esc_html__( 'Category Archives: ', 'royal' ) . single_cat_title( '', false );
            }
            elseif ( is_tax( 'post_format', 'post-format-aside' ) ) {
                return esc_html__( 'Asides', 'royal' );
            }
            elseif ( is_tax( 'post_format', 'post-format-video' ) ) {
                return esc_html__( 'Videos', 'royal' );
            }
            elseif ( is_tax( 'post_format', 'post-format-audio' ) ) {
                return esc_html__( 'Audio', 'royal' );
            }
            elseif ( is_tax( 'post_format', 'post-format-quote' ) ) {
                return esc_html__( 'Quotes', 'royal' );
            }
            elseif ( is_tax( 'post_format', 'post-format-gallery' ) ) {
                return esc_html__( 'Galleries', 'royal' );
            }
            else {
                return esc_html__( 'Archives', 'royal' );
            }
        }
        ...
        ?>
            <ul class="links<?php echo ( isset( $args['newsletter'] ) && $args['class'] ) ? ' ' . $args['class'] : '' ; ?>">
                <?php if( (! isset( $args['newsletter'] ) && etheme_get_option( 'promo_popup' ) ) || ( isset( $args['newsletter'] ) && $args['newsletter'] == true ) ): ?>
                    <li class="popup_link <?php if(!etheme_get_option('promo_link')): ?>hidden<?php endif; if(etheme_get_option('fixed_ppopup')): ?>laptop-visible<?php endif;?>"><a class="etheme-popup <?php echo (etheme_get_option('promo_auto_open')) ? 'open-click': '' ; ?>" href="#etheme-popup"><?php if ( etheme_get_option('pp_title') == '' ) { esc_html_e('Newsletter', 'royal'); } else { echo etheme_get_option('pp_title'); } ?></a></li>
                <?php endif; ?>

                <?php if(etheme_get_option('top_links')): ?>
                    <?php if ( is_user_logged_in() ) : ?>
                        <?php if(class_exists('Woocommerce')): ?>
                            <li class="my-account-link"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php esc_html_e( 'My Account', 'royal' ); ?></a></li>
                        <?php endif; ?>
                        <li class="logout-link"><a href="<?php echo wp_logout_url(home_url()); ?>"><?php esc_html_e( 'Logout', 'royal' ); ?></a></li>
                    <?php else : ?>
                        <?php
                        ...
                        <?php if(class_exists('Woocommerce')): ?>
                            <li class="login-link">
                                <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php esc_html_e( 'Sign In', 'royal' ); ?></a>
                                <?php if($popups) : ?>
                                    <div class="login-popup">
                                        <div class="popup-title">
                                            <span><?php esc_html_e( 'Login Form', 'royal' ); ?></span>
                                        </div>
                                            ...
                                            <form method="post" class="form-login" action="<?php echo get_the_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>">
                                                ...
                                                <p class="form-row">
                                                    ...
                                                    <input type="submit" class="button" name="login" value="<?php esc_html_e( 'Login', 'royal' ); ?>" />
                                                </p>
                        ...
                        <?php if( get_option('users_can_register') && ( ! empty( $reg_id ) || ( isset( $args['register'] ) && $args['register'] == true ) ) ): ?>
                            <li class="register-link">
                                <a href="<?php echo $reg_url; ?>"><?php esc_html_e( 'Register', 'royal' ); ?></a>
                                <?php if($popups) : ?>
                                    <div class="register-popup">
                                        <div class="popup-title">
                                            <span><?php esc_html_e( 'Register Form', 'royal' ); ?></span>
                                        </div>
...
if(!function_exists('et_get_main_menu')) {
    function et_get_main_menu( $menu_id = 'main-menu', $class = '' ) {
        ...
        if ( has_nav_menu( $menu_id ) ) {
            ...
            ?>
                <br>
                <h4 class="a-center"><?php esc_html_e('Set your main menu in', 'royal');?> <em><?php esc_html_e( 'Appearance &gt; Menus', 'royal'); ?></em></h4>
            <?php
        }
    }
}
            ...
            <div class="header-search <?php echo $class; ?>">
                <?php if($search_view == 'modal'): ?>
                    <div class="et-search-trigger">
                        <a class="popup-with-form" href="#searchModal"><i class="fa fa-search"></i> <span><?php esc_html_e('Search', 'royal'); ?></span></a>
                    </div>
                <?php else : ?>
        ...
        ?>
            <div id="searchModal" class="mfp-hide modal-type-1 zoom-anim-dialog" role="search">
                <div class="modal-dialog text-center">
                    <h3 class="large-h"><?php esc_html_e('Search engine', 'royal'); ?></h3>
                    <small class="mini-text"><?php esc_html_e('Use this form to find things you need on this site', 'royal'); ?></small>
        ...
        ?>
            <form class="et-register-form form-<?php echo $rand; ?>" action="" method="get">
                ...
                <div class="login-fields">
                    <p class="form-row">
                        <label class=""><?php esc_html_e( "Enter your username", 'royal' ) ?> <span class="required">*</span></label>
                        <input type="text" name="username" class="text input-text" />
                    </p>
                    <p class="form-row">
                        <label class=""><?php esc_html_e( "Enter your E-mail address", 'royal' ) ?> <span class="required">*</span></label>
                        <input type="text" name="email" class="text input-text" />
                    </p>
                    <p class="form-row">
                        <label class=""><?php esc_html_e( "Enter your password", 'royal' ) ?> <span class="required">*</span></label>
                        <input type="password" name="et_pass" class="text input-text" />
                    </p>
                    <p class="form-row">
                        <label class=""><?php esc_html_e( "Re-enter your password", 'royal' ) ?> <span class="required">*</span></label>
                ...
                <p class="form-row right">
                    ...
                    <button class="btn btn-black big text-center submitbtn" type="submit"><span><?php esc_html_e( "Register", 'royal' ) ?></span></button>
                </p>
            </form>
            <script type="text/javascript">
                jQuery(function($){
...
if(!function_exists('et_send_msg_action')) {
    function et_send_msg_action() {
        ...
        if(isset($_GET['contact-submit'])) {
            ...
            if( ! $captcha_instance->check( $_GET['captcha-prefix'], $_GET['captcha-word'] ) ) $return['msg'][] = esc_html__( 'The security code you entered did not match. Please try again.', 'royal' );

            if( trim( $_GET['contact-name'] ) === '') $return['msg'][] = esc_html__( 'fill in the "Name and Surname" field.', 'royal' );

            if( trim( $_GET['contact-email'] ) === '' || !isValidEmail( $_GET['contact-email'] ) ) $return['msg'][] = esc_html__( 'Please enter a valid email.', 'royal' );

            if( trim( $_GET['contact-msg'] ) === '') $return['msg'][] = esc_html__( 'fill in the "Message" field.', 'royal' );
            ...
            if( ! isset( $return['msg'] ) ) {
                ...
                if(wp_mail($reciever_email, $subject, $body, $headers)) {
                    ...
                    $return['msg'] = esc_html__('All is well, your email has been sent.', 'royal');
                } else{
                    $return['status'] = 'error';
                    $return['msg'] = esc_html__('Error while sending a message!', 'royal');
                }
...
if(!function_exists('et_register_action')) {
    function et_register_action() {
        ...
        if( ! empty( $_POST['input_data'] ) ){
            ...
            if( ! $captcha_instance->check( $captcha_prefix, $captcha_word ) ) $return['msg'][] = esc_html__('The security code you entered did not match. Please try again.', 'royal');

            if( empty( $username ) ) $return['msg'][] = esc_html__( "User name should not be empty.", 'royal' );

            if( ! preg_match("/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,4})$/", $email ) )  $return['msg'][] = esc_html__( "Please enter a valid email.", 'royal' );

            if( empty( $pass ) || strlen( $pass ) < 5 ) $return['msg'][] = esc_html__( "Password should have more than 5 symbols", 'royal' );

            if( empty( $pass2 ) || strlen( $pass2 ) < 5 ) $return['msg'][] = esc_html__( "Re-enter password should have more than 5 symbols", 'royal' );

            if( $pass != $pass2 ) $return['msg'][] = esc_html__( "The passwords do not match", 'royal' );

            if ( email_exists( $email ) ) $return['msg'][] = esc_html__( "That email already exists. Please try another one.", 'royal' );

            if ( username_exists( $username ) ) $return['msg'][] = esc_html__( "Username already exists. Please try another one.", 'royal' );
            ...
            if ( isset( $return['msg'] ) ) {
                ...
                $subject = esc_html__( "Registration successful", 'royal' );
                $subject2admin = esc_html__( "New user registration", 'royal' );
                ...
                $return['status'] = 'success';
                $return['msg'] = esc_html__( "Please check your email for login details.", 'royal' );
                echo json_encode( $return );
            }
            die();
        }
        ...
        ob_start(); ?>
            <div style="background-color: #f5f5f5;width: 100%;-webkit-text-size-adjust: none;margin: 0;padding: 70px 0 70px 0;">
                <div style="-webkit-box-shadow: 0 0 0 3px rgba(0,0,0,0.025) ;box-shadow: 0 0 0 3px rgba(0,0,0,0.025);-webkit-border-radius: 6px;border-radius: 6px ;background-color: #fdfdfd;border: 1px solid #dcdcdc; padding:20px; margin:0 auto; width:500px; max-width:100%; color: #737373; font-family:Arial; font-size:14px; line-height:150%; text-align:left;">
                    ...
                    <?php endif ; ?>
                    <p><?php printf(__('Thanks for creating an account on %s. Your username is %s.', 'royal'), get_bloginfo( 'name' ), $username);?></p>
                    <?php if (class_exists('Woocommerce')): ?>

                        <p><?php printf(__('You can access your account area to view your orders and change your password here: <a href="%s">%s</a>.', 'royal'), get_permalink( get_option('woocommerce_myaccount_page_id') ), get_permalink( get_option('woocommerce_myaccount_page_id') ));?></p>
            ...
            <div style="background-color: #f5f5f5;width: 100%;-webkit-text-size-adjust: none;margin: 0;padding: 70px 0 70px 0;">
                <div style="-webkit-box-shadow: 0 0 0 3px rgba(0,0,0,0.025) ;box-shadow: 0 0 0 3px rgba(0,0,0,0.025);-webkit-border-radius: 6px;border-radius: 6px ;background-color: #fdfdfd;border: 1px solid #dcdcdc; padding:20px; margin:0 auto; width:500px; max-width:100%; color: #737373; font-family:Arial; font-size:14px; line-height:150%; text-align:left;">
                    ...
                    <?php else: ?>
                        <a href="<?php echo home_url(); ?>" style="display:block; text-align:center;"><img style="max-width:100%;" src="<?php echo PARENT_URL.'/images/logo.png'; ?>" alt="<?php bloginfo('name'); ?>"></a>
                    <?php endif ; ?>
                    <p><?php printf(__('New user registration on %s. Username: %s.', 'royal'), get_bloginfo( 'name' ), $username);?></p>
        ...
        if(get_comment_type() == 'pingback' || get_comment_type() == 'trackback') :
            ...
            <li id="comment-<?php comment_ID(); ?>" class="pingback">
                <div class="comment-block row">
                    <div class="col-md-12">
                        <div class="author-link"><?php esc_html_e('Pingback:', 'royal') ?></div>
                ...
                <div class="media">
                    <h4 class="media-heading"><?php esc_html_e('Pingback:', 'royal') ?></h4>
            ...
            <li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
                <div class="media">
                    ...
                    <?php if ($comment->comment_approved == '0'): ?>
                        <p class="awaiting-moderation"><?php esc_html__('Your comment is awaiting moderation.', 'royal') ?></p>
                    <?php endif ?>

                    <?php comment_text(); ?>
                    <?php comment_reply_link(array_merge($args, array('reply_text' => esc_html__('Reply to comment', 'royal'),'depth' => $depth, 'max_depth' => $args['max_depth']))); ?>

                    <?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) : ?>

                        <div class="star-rating" title="<?php echo sprintf( esc_html__( 'Rated %d out of 5', 'royal' ), $rating ) ?>">
                            <span style="width:<?php echo ( $rating / 5 ) * 100; ?>%"><strong><?php echo $rating; ?></strong> <?php esc_html_e( 'out of 5', 'royal' ); ?></span>
                        </div>
...
if(!function_exists('etheme_custom_comment_form')) {
    function etheme_custom_comment_form($defaults) {
        ...
        $defaults['comment_field'] = '<div class="form-group"><label for="comment" class="control-label">'.__('Comment', 'royal').'</label><textarea class="form-control required-field"  id="comment" name="comment" cols="45" rows="12" aria-required="true"></textarea></div>';
    ...
    function etheme_custom_comment_form_fields() {
        ...
        $fields = array(
            ...
            'url' => '<div class="form-group comment-form-url">'.
                            '<label for="url" class="control-label">'.__('Website', 'royal').'</label>'.
...
if(function_exists('register_sidebar')) {
    register_sidebar(array(
        'name' => esc_html__('Main Sidebar', 'royal'),
        'id' => 'main-sidebar',
        'description' => esc_html__('Sidebar that appears on the pages and posts.', 'royal'),
    ...
    register_sidebar(array(
        'name' => esc_html__('Shop Sidebar', 'royal'),
        'id' => 'shop-sidebar',
        'description' => esc_html__('Sidebar that appears on Shop page.', 'royal'),
        'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
        'after_widget' => '</div><!-- //sidebar-widget -->',
        'before_title' => '<h4 class="widget-title"><span>',
        'after_title' => '</span></h4>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Additional Shop Widget area', 'royal'),
        'id' => 'shop-widgets-area',
        'description' => esc_html__('Widget area that appears above the products on Shop page', 'royal'),
        'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
        'after_widget' => '</div><!-- //sidebar-widget -->',
        'before_title' => '<h4 class="widget-title"><span>',
        'after_title' => '</span></h4>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Single product page Sidebar', 'royal'),
        'id' => 'single-sidebar',
        'description' => esc_html__('Sidebar that appears on the single product page.', 'royal'),
        'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
        'after_widget' => '</div><!-- //sidebar-widget -->',
        'before_title' => '<h4 class="widget-title"><span>',
        'after_title' => '</span></h4>',
    ...
    if(function_exists('is_bbpress')){
        register_sidebar(array(
            'name' => esc_html__('Forum Sidebar', 'royal'),
            'id' => 'forum-sidebar',
            'description' => esc_html__('Sidebar for bbPress forum', 'royal'),
            'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
            'after_widget' => '</div><!-- //sidebar-widget -->',
            'before_title' => '<h4 class="widget-title"><span>',
            'after_title' => '</span></h4>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Left side top bar area', 'royal'),
        'id' => 'languages-sidebar',
        'description' => esc_html__('Can be used for placing languages switcher of some contacts information.', 'royal'),
    ...
    register_sidebar(array(
        'name' => esc_html__('Right side top bar area', 'royal'),
        'id' => 'top-bar-right',
        'before_widget' => '<div id="%1$s" class="topbar-widget %2$s">',
        'after_widget' => '</div><!-- //topbar-widget -->',
        'before_title' => '<h4 class="widget-title"><span>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Mobile navigation sidebar', 'royal'),
        'id' => 'mobile-sidebar',
        'description' => esc_html__('Area in a hidden sidebar on mobile devices, after navigation.', 'royal'),
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 1', 'royal'),
        'id' => 'footer1',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 2', 'royal'),
        'id' => 'footer2',
        'description' => 'Appears in the footer section of the site',
        'before_widget' => '<div id="%1$s" class="footer-sidebar-widget %2$s">',
        'after_widget' => '</div><!-- //sidebar-widget -->',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer Copyright', 'royal'),
        'id' => 'footer9',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer Links', 'royal'),
        'id' => 'footer10',
        ...
        if(isset($word) && $word != '') {
            ...
            if($_GET['products'] && class_exists('WooCommerce')) {
                $products_args = array(
                    ...
                    'image' => $_GET['images'],
                    'link' => true,
                    'title' => esc_html__('View Products', 'royal'),
            ...
            if($_GET['posts']) {
                $posts_args = array(
                    ...
                    'title' => esc_html__('From the blog', 'royal'),
                    'image' => $_GET['images'],
                    'link' => true,
            ...
            if($_GET['portfolio']) {
                $portfolio_args = array(
                    ...
                    'image' => $_GET['images'],
                    'link' => false,
                    'title' => esc_html__('Portfolio', 'royal'),
            ...
            if($_GET['testimonial']) {
                $testimonial_args = array(
                    ...
                    'image' => $_GET['images'],
                    'link' => false,
                    'title' => esc_html__('Testimonial', 'royal'),
        ...
        if ( $query->have_posts() ) {
            ...
            if($title != '') {
                ?>
                    ...
                    <h5 class="title"><span><?php if($link): ?><a href="<?php echo esc_url( get_home_url().'/?s='.$args['s'].'&post_type='.$args['post_type'] ); ?>" title="<?php echo esc_attr(__('Show all', 'royal')); ?>"><?php endif; ?>
                        <?php echo $title; ?>
...
if(!function_exists('etheme_posted_info')) {
    function etheme_posted_info ($title = ''){
        ...
        $posted_by .= esc_html__('Posted on', 'royal').' ';
        $posted_by .= get_the_time(get_option('date_format')).' ';
        $posted_by .= get_the_time(get_option('time_format')).' ';
        $posted_by .= '</span>';
        $posted_by .= '<span class="posted-by"> '.__('by', 'royal').' '.get_the_author_link().'</span>';
        $posted_by .= '</div>';
                                        ...
                                        echo '<div class="post-news">';
                                            ...
                                            echo '<div class="zoom">';
                                                echo '<div class="btn_group">';
                                                    if($lightbox):
                                                        echo '<a href="'.etheme_get_image(false).'" class="btn btn-black xmedium-btn" rel="lightbox"><span>'.__('View large', 'royal').'</span></a>';
                                                    endif;
                                                    echo '<a href="'.get_permalink().'" class="btn btn-black xmedium-btn"><span>'.__('More details', 'royal').'</span></a>';
                                                echo '</div>';
                                                echo '<i class="bg"></i>';
                                            echo '</div>';
                                        echo '</div>';
...
function etheme_sidebar_form(){
    ...
    <form action="<?php echo admin_url( 'widgets.php' ); ?>" method="post" id="etheme_add_sidebar_form">
        <h2><?php esc_html_e('Custom Sidebar', 'royal'); ?></h2>
        ...
        <button type="submit" class="button-primary" value="add-sidebar"><?php esc_html_e('Add Sidebar', 'royal'); ?></button>
    </form>
    <script type="text/javascript">
...
if(!function_exists('etheme_breadcrumbs')) {
    function etheme_breadcrumbs() {
      ...
      $home = esc_html__('Home', 'royal'); // text for the 'Home' link
      $blogPage = esc_html__('Blog', 'royal');
      ...
      if (is_front_page()) {
        ...
        if ( is_category() ) {
          ...
          echo $before .  esc_html__( 'Archive by category "', 'royal' ) . single_cat_title('', false) . '"' . $after;

        } elseif ( is_search() ) {
          echo $before . esc_html__( 'Search results for "', 'royal' ) . get_search_query() . '"' . $after;
          ...
          echo $before .  esc_html__( 'Posts tagged "', 'royal' ) . single_tag_title('', false) . '"' . $after;

        } elseif ( is_author() ) {
           global $author;
          $userdata = get_userdata($author);
          echo $before .  esc_html__( 'Articles posted by ', 'royal' ) . $userdata->display_name . $after;

        } elseif ( is_404() ) {
          echo $before . esc_html__( 'Error 404', 'royal' ) . $after;
        }else{
...
if(!function_exists('et_back_to_page')) {
    function et_back_to_page() {
        echo '<a class="back-history" href="javascript: history.go(-1)">'.__('Return to Previous Page', 'royal').'</a>';
    }
}
...
function etheme_custom_fonts(){
    ...
    if ( $fonts ) {
        foreach ( $fonts as $value ) {
            $ot_font_families[$value['name']] = $value['name'] . esc_html__(' (loaded)', ETHEME_DOMAIN );
        }
    }
...
function etheme_taxonomy_edit_meta_field($term, $taxonomy) {
    ...
    if(!$term_meta){$term_meta = et_add_term_meta($id, 'cat_meta', '');}
     ?>
    <tr class="form-field">
    <th scope="row" valign="top"><label for="term_meta[cat_header]"><?php esc_html_e( 'Category Header', 'royal' ); ?></label></th>
        <td>
            <?php
...
function etheme_print_tweet_error($errorArray) {
    return '<p class="eth-error">' . esc_html__('Error: ', 'royal' ) . $errorArray['message'] . esc_html__('in ', 'royal' ) . $errorArray['file'] . esc_html__( 'on line ', 'royal' ) . $errorArray['line'] . '</p>';
...
if(!function_exists('et_get_related_posts')) {
    function et_get_related_posts($postId = false, $limit = 5){
        ...
        if ($categories) {
            ...
            etheme_create_posts_slider($args, esc_html__('Related posts', 'royal'), false, true, true);
        }
    }
}
...
if( ! function_exists( 'etheme_activation_bar_out' ) ) :
    function etheme_activation_bar_out() {
        ?>
            <div class="etheme-activation-bar"><?php esc_html_e('Important Note: You need to ', 'royal' ); ?><a href="<?php echo admin_url( 'admin.php?page=etheme_activation_page' ); ?>"><?php esc_html_e('activate Royal template', 'royal' ); ?> </a> <?php esc_html_e( 'with your purchase code to continue working.', 'royal' ); ?></div>
        <?php
    }
endif;
...
if(!function_exists('et_register_static_blocks')) {
    function et_register_static_blocks() {
            $labels = array(
                'name' => _x( 'Static Blocks', 'post type general name', 'royal' ),
                'singular_name' => _x( 'Block', 'post type singular name', 'royal' ),
                'add_new' => _x( 'Add New', 'static block', 'royal' ),
                'add_new_item' => sprintf( esc_html__( 'Add New %s', 'royal' ), esc_html__( 'Static Blocks', 'royal' ) ),
                'edit_item' => sprintf( esc_html__( 'Edit %s', 'royal' ), esc_html__( 'Static Blocks', 'royal' ) ),
                'new_item' => sprintf( esc_html__( 'New %s', 'royal' ), esc_html__( 'Static Blocks', 'royal' ) ),
                'all_items' => sprintf( esc_html__( 'All %s', 'royal' ), esc_html__( 'Static Blocks', 'royal' ) ),
                'view_item' => sprintf( esc_html__( 'View %s', 'royal' ), esc_html__( 'Static Blocks', 'royal' ) ),
                'search_items' => sprintf( esc_html__( 'Search %a', 'royal' ), esc_html__( 'Static Blocks', 'royal' ) ),
                'not_found' =>  sprintf( esc_html__( 'No %s Found', 'royal' ), esc_html__( 'Static Blocks', 'royal' ) ),
                'not_found_in_trash' => sprintf( esc_html__( 'No %s Found In Trash', 'royal' ), esc_html__( 'Static Blocks', 'royal' ) ),
                'parent_item_colon' => '',
                'menu_name' => esc_html__( 'Static Blocks', 'royal' )
        ...
        ?>
            <div id="etheme-popup" class="white-popup-block mfp-hide mfp-with-anim zoom-anim-dialog">
                ...
                <p class="checkbox-label">
                    ...
                    <label for="showagain"><?php esc_html_e("Don't show this popup again", 'royal'); ?></label>
                </p>
            </div>
            <style type="text/css">
                #etheme-popup {
...
if( ! function_exists( 'etheme_get_slider_params' ) ) {
    function etheme_get_slider_params() {
        return array(
            array(
                "type" => "textfield",
                "heading" => esc_html__("Slider speed", 'royal'),
                "param_name" => "slider_speed",
                "group" => esc_html__('Slider settings', 'royal')
            ),
            array(
                "type" => "checkbox",
                "heading" => esc_html__("Slider autoplay", 'royal'),
                "param_name" => "slider_autoplay",
                "group" => esc_html__('Slider settings', 'royal'),
                'value' => array( esc_html__( 'Yes, please', 'royal' ) => 'yes' )

            ),
            array(
                "type" => "checkbox",
                "heading" => esc_html__("Hide prev/next buttons", 'royal'),
            ...
            array(
                'type' => 'dropdown',
                'heading' => esc_html__( 'Pagination type', 'royal' ),
                'param_name' => 'pagination_type',
                'group' => esc_html__('Slider settings', 'royal'),
                'value' => array(
                    __( 'Hide', 'royal' ) => 'hide',
                    __( 'Bullets', 'royal' ) => 'bullets',
                    __( 'Lines', 'royal' ) => 'lines',
                ),
            ),
            array(
                'type' => 'dropdown',
                'heading' => esc_html__( 'Hide pagination only for', 'royal' ),
                'param_name' => 'hide_fo',
                'dependency' => array(
                ...
                'value' => array(
                    '' => '',
                    __( 'Mobile', 'royal' ) => 'mobile',
                    __( 'Desktop', 'royal' ) => 'desktop',
                ),
            ),
            array(
                "type" => "colorpicker",
                "heading" => __( "Pagination default color", "royal" ),
            ...
            array(
                "type" => "colorpicker",
                "heading" => __( "Pagination active color", "royal" ),
            ...
            array(
                "type" => "textfield",
                "heading" => esc_html__("Number of slides on large screens", 'royal'),
                "param_name" => "large",
                "group" => esc_html__('Slider settings', 'royal')
            ),
            array(
                "type" => "textfield",
                "heading" => esc_html__("On notebooks", 'royal'),
                "param_name" => "notebook",
                "group" => esc_html__('Slider settings', 'royal')
            ),
            array(
                "type" => "textfield",
                "heading" => esc_html__("On tablet landscape", 'royal'),
                "param_name" => "tablet_land",
                "group" => esc_html__('Slider settings', 'royal')
            ),
            array(
                "type" => "textfield",
                "heading" => esc_html__("On tablet portrait", 'royal'),
                "param_name" => "tablet_portrait",
                "group" => esc_html__('Slider settings', 'royal')
            ),
            array(
                "type" => "textfield",
                "heading" => esc_html__("On mobile", 'royal'),
                "param_name" => "mobile",
                "group" => esc_html__('Slider settings', 'royal')
            ),
        );
