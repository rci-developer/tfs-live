...
class Woothemes_Widget_Testimonials extends WP_Widget {
	...
	public function __construct() {
		...
		$this->woothemes_widget_description = esc_html__( 'Recent testimonials on your site.', 'royal' );
		$this->woothemes_widget_idbase = 'woothemes_testimonials';
		$this->woothemes_widget_title = esc_html__( 'Testimonials', 'royal' );
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title (optional):', 'royal' ); ?></label>
			<input type="text" name="<?php echo $this->get_field_name( 'title' ); ?>"  value="<?php echo $instance['title']; ?>" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" />
		</p>
		<!-- Widget Limit: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php esc_html_e( 'Limit:', 'royal' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'size' ); ?>"><?php esc_html_e( 'Image Size (in pixels):', 'royal' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'orderby' ); ?>"><?php esc_html_e( 'Order By:', 'royal' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'order' ); ?>"><?php esc_html_e( 'Order Direction:', 'royal' ); ?></label>
		...
		<!-- Widget Display Navigation: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'navigation' ); ?>"><?php esc_html_e( 'Display Control Navigation', 'royal' ); ?></label>
	   	</p>
		<!-- Widget Display Author: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_author' ); ?>"><?php esc_html_e( 'Display Author', 'royal' ); ?></label>
	   	</p>
		<!-- Widget Display Avatar: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_avatar' ); ?>"><?php esc_html_e( 'Display Avatar', 'royal' ); ?></label>
	   	</p>
       	...
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_url' ); ?>"><?php esc_html_e( 'Display URL', 'royal' ); ?></label>
	   	</p>
	   	<!-- Widget Category: Select Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php esc_html_e( 'Category:', 'royal' ); ?></label>
			<?php
				$dropdown_args = array( 'taxonomy' => 'testimonial-category', 'class' => 'widefat', 'show_option_all' => esc_html__( 'All', 'royal' ), 'id' => $this->get_field_id( 'category' ), 'name' => $this->get_field_name( 'category' ), 'selected' => $instance['category'] );
				wp_dropdown_categories( $dropdown_args );
			?>
		</p>
		<!-- Widget ID: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'specific_id' ); ?>"><?php esc_html_e( 'Specific ID (optional):', 'royal' ); ?></label>
		...
		<p><small><?php esc_html_e( 'Display a specific testimonial, rather than a list.', 'royal' ); ?></small></p>
<?php
	} // End form()
	...
	protected function get_orderby_options () {
		return array(
					'none' => esc_html__( 'No Order', 'royal' ),
					'ID' => esc_html__( 'Entry ID', 'royal' ),
					'title' => esc_html__( 'Title', 'royal' ),
					'date' => esc_html__( 'Date Added', 'royal' ),
					'menu_order' => esc_html__( 'Specified Order Setting', 'royal' ),
					'rand' => esc_html__( 'Random Order', 'royal' )
					);
	...
	protected function get_order_options () {
		return array(
					'ASC' => esc_html__( 'Ascending', 'royal' ),
					'DESC' => esc_html__( 'Descending', 'royal' )
					);
