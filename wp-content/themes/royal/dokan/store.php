        ...
        <div class="widget-area collapse widget-collapse">
            ...
            if ( ! dynamic_sidebar( 'sidebar-store' ) ) {
                ...
                if ( class_exists( 'Dokan_Store_Location' ) ) {
                    the_widget( 'Dokan_Store_Category_Menu', array( 'title' => __( 'Store Category', 'royal' ) ), $args );
                    the_widget( 'Dokan_Store_Location', array( 'title' => __( 'Store Location', 'royal' ) ), $args );
                    the_widget( 'Dokan_Store_Contact_Form', array( 'title' => __( 'Contact Seller', 'royal' ) ), $args );
                }
...
<div id="primary" class="content-area dokan-single-store col-md-9">
    <div id="content" class="site-content store-page-wrap woocommerce" role="main">
        ...
        <?php } else { ?>
            ...
            <p class="dokan-info"><?php esc_html_e( 'No products were found of this seller!', 'royal' ); ?></p>
