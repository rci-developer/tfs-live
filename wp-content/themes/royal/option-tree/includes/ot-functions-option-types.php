  ...
  function ot_type_textarea_simple( $args = array() ) {
    ...
    echo '<div class="format-setting type-textarea simple ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        // ! et_textarea_simple_default fix
        if ( $et_textarea_simple_default && ! $field_value ) {
          $field_value = $et_textarea_simple_default;
        }
...
if ( ! function_exists( 'ot_type_custom_fonts' ) ) {
  function ot_type_custom_fonts( $args = array() ){
    $fonts_uploader = new Etheme_fonts_uploader();
    $fonts_uploader->enqueue();
    echo $fonts_uploader->render();
  }
}
